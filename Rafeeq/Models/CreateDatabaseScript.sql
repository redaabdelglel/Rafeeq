...
(@AishaId, 1, '09:00:00', '12:00:00'),
(@AishaId, 3, '14:00:00', '17:00:00'),
(@OmarId, 2, '10:00:00', '13:00:00'),
(@OmarId, 4, '15:00:00', '18:00:00'),
(@NouraId, 5, '09:00:00', '11:00:00');
...
(@OmarId, @KhaledId, 'Interview', DATEADD(day, 2, GETDATE()), DATEADD(hour, 1, DATEADD(day, 2, GETDATE())), 'Confirmed', 'https://meet.google.com/klm-nopq-rst', 'Unpaid', 90.00, 9.00, GETDATE(), NULL, 0),
(@AishaId, @KhaledId, 'Mentorship', DATEADD(day, 5, GETDATE()), DATEADD(hour, 1, DATEADD(day, 5, GETDATE())), 'Pending', NULL, 'Unpaid', 75.00, 7.50, GETDATE(), NULL, 0),
(@OmarId, @SarahId, 'Mentorship', DATEADD(day, -3, GETDATE()), DATEADD(hour, 1, DATEADD(day, -3, GETDATE())), 'Cancelled', NULL, 'Refunded', 90.00, 9.00, DATEADD(day, -4, GETDATE()), GETDATE(), 0);
